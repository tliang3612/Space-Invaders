...
class LandingPage:
    ...
    def __init__(self, game):
        ...
        strings = [('SPACE', WHITE, headingFont), ('INVADERS', GREEN, subheadingFont),
                   ...
                   ('= 40 PTS', GREY, font), ('= 100', GREY, font),
        ...
        self.alien_one = Alien(game=game, image_list=LandingPage.alien_one_imgs, v=Vector(), ul=(centerx - 125, 360))
        self.alien_two = Alien(game=game, image_list=LandingPage.alien_two_imgs, v=Vector(), ul=(centerx - 140, 420))
        self.alien_three = Alien(game=game, image_list=LandingPage.alien_three_imgs, v=Vector(), ul=(centerx - 130, 490))
        self.ufo = Alien(game=game, image_list=LandingPage.ufo_imgs, v=Vector(), ul=(centerx - 120, 550))
